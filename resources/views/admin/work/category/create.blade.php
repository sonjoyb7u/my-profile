...
@section('title', 'CREATE CATEGORY | MY PROFILE')
        ...
        <div class="content-header">
            ...
            <div class="leftside-content-header">
                <ul class="breadcrumbs">
                    ...
                    <li><a href="{{ route('admin.category.create') }}"><i class="fa fa-list-alt" aria-hidden="true"></i>Category</a></li>
                    <li><a href="{{ route('admin.category.create') }}"><i class="fa fa-edit"  aria-hidden="true"></i>Create Category</a></li>
                </ul>
            </div>
        </div>
        <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
