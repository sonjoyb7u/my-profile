        ...
        <div class="row mt-5">
            <div class="col-lg-4 mt-3">
                <div class="rounded bg-white p-2" data-aos="fade-up">
                    <div class="img_blog">
                        <img src="{{ asset('assets/site/images/blog/blog-1.jpg') }}" alt="" class="img-fluid rounded mx-auto d-block">
                    </div>
                    <div class="content_blog pt-3 pb-3">
                        ...
                        <div class="mt-3">
                            <p class="h6 text-muted date_blog mb-0">11 March 2019 <a href="#" class="text-custom font-weight-bold">By Clinent-1</a></p>
